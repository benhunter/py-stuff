...
# 18DEC16
# Python 2.7. Rewriting for Python 3.5

# >python -i pwd-chk.py --password SECRET -v 
# >python -i .\pwd-chk.py -p secretSECRET123!@# -l 10 -a 3 -A 3 -n 3 -s 3

#TODO add debug flag that shows the REGEX expressions that are built and the result of executing them

import re
import argparse

#password = 'This is Only a Test.'
failed = False # did the password fail a test yet? Set true if password failed.
...
parser.add_argument('--set', help="set of special characters allowed, default is \"!@#$%^&*.\"", default="!@#$%^&*.", type=str)
